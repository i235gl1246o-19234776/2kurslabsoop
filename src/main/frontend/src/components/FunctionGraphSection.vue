<template>
  <div class="graph-section">
    ...
    <CreateTabulatedFunctionDialog
      :is-open="isCreateFromXYDialogOpen"
      :current-user-id="currentUserId"
      @close="closeCreateFromXYDialog"
    ...
    <RemovePointDialog
      ...
      :point-count="functionData ? functionData.points.length : 0"
...
export default {
  ...
  methods: {
    ...
    async onFunctionCreated({ functionId, functionName }) {
      console.log('FunctionGraphSection: onFunctionCreated вызван с ID:', functionId, 'и именем:', functionName);
    ...
    async onFunctionLoaded({ functionId, functionName }) {
      console.log('FunctionGraphSection: onFunctionLoaded вызван с ID:', functionId, 'и именем:', functionName);
    ...
    async loadFunctionData(functionId, functionName) {
      console.log('FunctionGraphSection: loadFunctionData вызван с ID:', functionId, 'и именем:', functionName);
      ...
      try {
        ...
        const functionData = await api.getFunctionById(functionId);
        ...
        console.log('Точки функции загружены:', points);
        ...
        console.error('FunctionGraphSection: Ошибка при загрузке точек функции:', err);
    ...
    clearFunction() {
      console.log('FunctionGraphSection: вызван clearFunction');
      this.destroyChart();
    ...
    handleError(message) {
      ...
      console.error('FunctionGraphSection error:', message);
